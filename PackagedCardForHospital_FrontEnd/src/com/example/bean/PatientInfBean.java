...
public class PatientInfBean {
	...
	public PatientInfBean(String p_ID, String sold_name, String sold_age, String sex, String u_native, String idNum, String phone, String address, String preStore, String deposit) {
		P_ID = p_ID;
