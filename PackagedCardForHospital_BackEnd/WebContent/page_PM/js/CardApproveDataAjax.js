function data() {
    ...
    this.makeRefreshJSON = function () {
        var tempJSON = {
            "S_Requester": PageData.S_Requester,
            "S_Status": PageData.S_Status,
            "S_Date_Start": PageData.S_Date_Start,
            "S_Date_End": PageData.S_Date_End,
    ...
    this.makeAddParamsJSON = function () {
        var params = {
            "app_requester": PageData.app_requester = $("#addPanel").attr("corid"),
