function Operation() {
    ...
    this.AddTableLine = function (obj) {
        ...
        for (var i = 0; i < obj.length; i++) {
            ...
            $("#table").append("<tr id =" + obj[i].arvl_ID + " >" +
                ...
                "<td><span corID ='" + obj[i].arvl_REMARK + "'>" + obj[i].arvl_CORID + "</span></td>" +
    ...
    this.showAddPanel = function (event) {
        $("#addPanel").attr("corid",$(event.parentElement.parentElement.children[3].children[0]).attr("corid"));
