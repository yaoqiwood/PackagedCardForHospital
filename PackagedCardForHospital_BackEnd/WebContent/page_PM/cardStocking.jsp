        ...
        <div id="addPanel">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input id="add_CNStart" class="addPanel addParams" type="text"></td>
                </tr>
                <tr>
                    <td><span>截至卡号：</span></td>
                    <td><input id="add_CNEND" class="addPanel addParams" type="text"></td>
                </tr>
                <tr>
                    <td><span>前缀：</span></td>
                    <td><input id="add_Prefix" class="addPanel preParams" type="text"></td>
                </tr>
                <tr>
                    <td colspan="2">
